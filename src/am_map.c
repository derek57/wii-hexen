...
//static int finit_height = SCREENHEIGHT - SBARHEIGHT - 3;			// CHANGED FOR HIRES
static int finit_height = SCREENHEIGHT - SBARHEIGHT - (3 << hires);		// CHANGED FOR HIRES
...
char *PlayerColorText[MAXPLAYERS] = {
    ...
    "YELLOW:",
    "GREEN:",
/*				// DEACTIVATED GRAPHICS FOR PLAYERS 5 TILL 8...
    "JADE:",			// ...AS THERE ARE NO SUCH STATUS BAR GRAPHICS...
    "WHITE:",			// ...FOR SOME HEXEN IWAD's WHICH ARE OUT THERE...
    "HAZEL:",			// ...IN THE WILD (SEE MORE INFO UPON VARIABLE...
    "PURPLE:"			// "#DEFINE MAXPLAYERS" IN THE FILE "H2DEF.H").
*/
};
/*
void AM_DrawDeathmatchStats(void)
