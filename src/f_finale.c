...
static void TextWrite(void)
{
    ...
    patch_t *w;
/*
    memcpy(I_VideoBuffer, W_CacheLumpNum(FinaleLumpNum, PU_CACHE),		// CHANGED FOR HIRES
           SCREENWIDTH * SCREENHEIGHT);						// CHANGED FOR HIRES
*/
    V_CopyScaledBuffer(I_VideoBuffer, W_CacheLumpNum(FinaleLumpNum, PU_CACHE),	// CHANGED FOR HIRES
	    ORIGWIDTH * ORIGHEIGHT);						// CHANGED FOR HIRES
    if (FinaleStage == 5)
